...
/**
 * @function DisplayNodeResolveTraits
 * @since 0.1.0
 * @hidden
 */
void DisplayNodeResolveTraits(DisplayNodeRef node);

/**
 * @function DisplayNodeResolveLayout
 * @since 0.1.0
 * @hidden
 */
void DisplayNodeResolveLayout(DisplayNodeRef node);
